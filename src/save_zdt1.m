function save_results()
    ...
    hv_nsga2 = HV(Population1, PF_ref);
    hv_nsga3 = HV(Population2, PF_ref);
    ...
    %% IGD calculation
    igd_nsga2 = calculate_native_igd(PF1, true_pf);
    igd_nsga3 = calculate_native_igd(PF2, true_pf);
    ...
    %% Export
    output_filename = 'zdt1_performance_summary.csv';
